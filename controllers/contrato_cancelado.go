...
// ContratoCanceladoController operations for ContratoCancelado
type ContratoCanceladoController struct {
	beego.Controller
}

// URLMapping ...
func (c *ContratoCanceladoController) URLMapping() {
...
func (c *ContratoCanceladoController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddContratoCancelado(&v); err == nil {
