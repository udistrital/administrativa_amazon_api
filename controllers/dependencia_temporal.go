...
// DependenciaTemporalController operations for DependenciaTemporal
type DependenciaTemporalController struct {
	beego.Controller
}

// URLMapping ...
func (c *DependenciaTemporalController) URLMapping() {
...
func (c *DependenciaTemporalController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddDependenciaTemporal(&v); err == nil {
