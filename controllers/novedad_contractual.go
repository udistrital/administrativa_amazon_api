...
// NovedadContractualController operations for NovedadContractual
type NovedadContractualController struct {
	beego.Controller
}

// URLMapping ...
func (c *NovedadContractualController) URLMapping() {
...
func (c *NovedadContractualController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNovedadContractual(&v); err == nil {
