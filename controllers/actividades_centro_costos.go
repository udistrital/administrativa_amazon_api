...
// ActividadesCentroCostosController operations for ActividadesCentroCostos
type ActividadesCentroCostosController struct {
	beego.Controller
}

// URLMapping ...
func (c *ActividadesCentroCostosController) URLMapping() {
...
func (c *ActividadesCentroCostosController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddActividadesCentroCostos(&v); err == nil {
